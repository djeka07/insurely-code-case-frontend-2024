...
export const messages: Record<MessageKeys, string> = {
  ...
  'Please enter a valid cell phone number.': 'Veuillez entrer un numéro de téléphone portable valide.',
  ...
  'Email needs to be at least 5 characters': "L'adresse e-mail doit comporter au moins 5 caractères",

  // Login
  'Sign in with username and password': "Se connecter avec un nom d'utilisateur et votre mot de passe",
  ...
  'The password need to be at least 8 characters': 'Le mot de passe doit comporter au moins 8 caractères',
  ...
  'Active termination powers of attorney for the user': "Pouvoirs de résiliation actifs pour l'utilisateur",
  ...
  'The customer approves receiving the link via SMS': 'Le client accepte de recevoir le lien par SMS',
  'The customer must approve receiving the link via SMS': 'Le client doit accepter de recevoir le lien par SMS',
  ...
  'This user has not collected any insurances yet.': "Cet utilisateur n'a pas encore contracté d'assurance.",
  Events: 'Événements',
  ...
  'That means the insurance cannot be cancelled': 'Cela signifie que l’assurance ne peut pas être annulée',
  'Something unexpected happened, please try again': "Quelque chose d'inattendu s'est produit, veuillez réessayer",
  'Fetching insurance': 'Obtenir une assurance',
  ...
  "The insurance's binding period is until {date}": "La période de validité de l'assurance est jusqu'au {date}",
  ...
  'You have sent a reminder once earlier today.': 'Vous avez envoyé un rappel une fois aujourd’hui.',
  'Do you want to delete the power of attorney?': 'Voulez-vous supprimer le pouvoir de résiliation?',
  ...
  // Session Pension
  'This user has not collected any pensions yet.': "Cet utilisateur n'a pas encore perçu de pensions.",
  ...
  'We found {insurances} that are not displayed': 'Nous avons trouvé {insurances} qui ne sont pas affichées',
  ...
  'Sessions with at least one completed collection': 'Sessions avec au moins une perception achevée',
  ...
  'Could not retrieve social security number': 'Impossible de récupérer le numéro de sécurité sociale',
  'Search for personal ID number / E-mail': "Recherche d'un numéro d'identification personnel / E-mail",
  Client: 'Client',
  All: 'Tout',
  From: 'À partir de',
  Show: 'Afficher',
  ...
  'How do I know it is safe to use?': 'Comment puis-je savoir si je peux les utiliser en toute sécurité ?',
  ...
  // Error Fallback
  'The page crashed, possible reasons could be:': "La page s'est bloquée, les raisons possibles peuvent être :",
