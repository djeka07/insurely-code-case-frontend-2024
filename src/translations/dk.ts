...
export const messages: Record<MessageKeys, string> = {
  ...
  'The customer approves receiving the link via SMS': 'Kunden giver samtykke til at modtage linket via SMS',
  'The customer must approve receiving the link via SMS': 'Kunden skal give samtykke til at modtage linket via SMS',
  'Send link': 'Send link',
  'SMS sent': 'SMS sendt',
  ...
  'This user has not collected any insurances yet.': 'Brugeren har ikke indsamlet nogen data endnu.',
  Events: 'Hændelse',
  ...
  'Fetching insurance': 'Hente forsikring',
  ...
  'Insurance terms does not support test environment': 'Forsikringsbetingelser understøtter ikke test environment',
  ...
  "The insurance's binding period is until {date}": 'Forsikringens bindende periode er indtil {date}.',
  ...
  'You have sent a reminder once earlier today.': 'Du har sendt en påmindelse en gang tidligere i dag.',
  ...
  // Session Pension
  'This user has not collected any pensions yet.': 'Denne bruger har endnu ikke optjent nogen pensioner.',
  ...
  'Something went wrong when logging in to {company}': 'Noget gik galt, da du loggede ind på {company}',
