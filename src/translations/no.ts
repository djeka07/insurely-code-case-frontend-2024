...
export const messages: Record<MessageKeys, string> = {
  ...
  'We will email you when your account has been activated.': 'Vi sender deg en e-post når kontoen din er aktivert.',
  ...
  'The customer must approve receiving the link via SMS': 'Kunden må godkjenne å motta lenken via SMS',
  ...
  'Fetching insurance': 'Henter forsikring',
  ...
  'Insurance terms does not support test environment': 'Forsikringsvilkår støtter ikke test environment',
  ...
  'You have sent a reminder once earlier today.': 'Du har sendt en påminnelse en gang tidligere i dag.',
  ...
  // Session Pension
  'This user has not collected any pensions yet.': 'Denne brukeren har ikke samlet inn noen pensjoner ennå.',
