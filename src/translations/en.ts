...
export const messages: Record<MessageKeys, string> = {
  ...
  'We will email you when your account has been activated.': 'We will email you when your account has been activated.',
  ...
  'Active termination powers of attorney for the user': 'Active termination powers of attorney for the user',
  ...
  'The customer approves receiving the link via SMS': 'The customer approves receiving the link via SMS',
  'The customer must approve receiving the link via SMS': 'The customer must approve receiving the link via SMS',
  'Send link': 'Send link',
  'SMS sent': 'SMS sent',
  ...
  'This user has not collected any insurances yet.': 'This user has not collected any insurances yet.',
  Events: 'Events',
  ...
  'Insurance terms does not support test environment': 'Insurance terms does not support test environment',
  ...
  "The insurance's binding period is until {date}": "The insurance's binding period is until {date}.",
  ...
  'After you have clicked on "Create power of attorney" a link will appear that you can send to the customer manually.':
    'After you have clicked on "Create power of attorney" a link will appear that you can send to the customer manually.',
  'Does the customer not get the power of attorney': 'Does the customer not get the power of attorney?',
  ...
  'Something went wrong when logging in to {company}': 'Something went wrong when logging in to {company}',
  ...
  // Analytics
  'No data available for current seller on selected dates': 'No data available for current seller on selected dates',
  ...
  'Sessions with at least one completed collection': 'Sessions with at least one completed collection',
  'Last week': 'Last week',
